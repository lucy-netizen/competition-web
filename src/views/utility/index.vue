<template>
  <div class="utility-page">
    <div class="page-header">
      <h1 class="main-title">月球与行星</h1>
      <h2 class="sub-title">Moon & Planets</h2>
      <div class="title-line"></div>
      <p class="page-desc">整合行星探测数据处理工具，提供图像融合、光谱反演、数据可视化等专业分析能力，助力行星科学研究。</p>
    </div>
    ...
    <div class="tool-card-container">
      ...
      >
        <div class="tool-img-box">
          <img
              :src="require(`@/assets/toolImgs/${tool.imageName}`)"
              :alt="tool.name"
              class="tool-img"
              title="点击查看工具详情"
          />
    ...
    return {
      toolList: [
        ...
        },
        {
          ...
          detailIntro: '介绍：\n'+
              '本工具针对月球和火星地质地貌研究时的数据处理需求，实现了月球与火星表面过程研究中常用处理功能，主要包括：（1）月球和火星表面多尺度地形因子计算；（2）基于深度学习的月球撞击坑、石块和火星撞击坑、沙丘自动提取；（3）月球和火星表面地质单元撞击坑统计定年；（4）典型地质要素制图。这一工具的主要目的是帮助研究者更便捷地分析和理解行星表面的地形特征，提取典型形貌要素，从而加速研究效率。\n',
          downloadUrl: 'test.zip'
        }
      ]
    }
